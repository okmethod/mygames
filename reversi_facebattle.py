...
def main():
	...
	image_player1 = pygame.transform.scale(pygame.image.load("media\chiharu-face.png"), (TILE_SIZE, TILE_SIZE))
	image_player2 = pygame.transform.scale(pygame.image.load("media\yabusan-face.png"), (TILE_SIZE, TILE_SIZE))
	...
	player1 = ['CHIHARU', (255, 192, 192), image_player1]
	player2 = ['YABUSAN', ( 64,  64,   0), image_player2]
