...
class GameStateReversi:
	...
	def __init__(self, board_size):
		...
		self.__player_data  = [{}, {}]
		self.__player_data[self.BLACK] = {'player_name' : 'Black', 'theme_color' : (  0,   0,   0), 'stone_count' : 0 }
		self.__player_data[self.WHITE] = {'player_name' : 'White', 'theme_color' : (255, 255, 255), 'stone_count' : 0 }
